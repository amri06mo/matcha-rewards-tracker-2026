...
b. calculate_matcha_units(profit, matcha_cost) : This function will convert the net profit made into "matcha currency" by dividing the profit by the cost of one latte (e.g., $9.00). It returns
