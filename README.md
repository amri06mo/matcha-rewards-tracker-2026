...
a 10% platform fee from the original cost to ensure user knows exactly how much "real" money 
was made before any spending.

b. calculate_matcha_units(profit, matcha_cost) : This function will convert the net profit made into "matcha currency" by dividong the profit by the cost of one latte (e.g., $9.00). It returns
